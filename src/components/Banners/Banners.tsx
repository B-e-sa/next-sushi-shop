        ...
        <div className='flex flex-col h-screen'>
            <div className='flex flex-row-reverse w-screen text-white' style={{ height: 'calc(100vh - 10vh)' }}>
                ...
                <div className='flex items-center relative'>
                    <div className='-z-50 '>
                        <div className='flex items-center justify-center animate-half-slow-spin self-center left-1 top-40'>
                            <GiPlainCircle className='fill-zinc-900 w-80 h-80 absolute' />
                            <GiPlainCircle className='fill-amber-200 -left-10 z-50 w-6 h-6 absolute' />
                    ...
                    <div>
                        <p className='text-6xl w-96 -mr-24 font-serif self-center'>
                            steaks<br />
